...
class TestTicketUpdater(unittest.TestCase):
    ...
    def test_run_ticket_not_found_fallback(self, mock_print):
        ...
        self.git_service.get_code_review_data.return_value = CodeReview(status=None, url=None, create_url="donut")

        # Use this ticket? yes. Refresh code review? no. Update ticket? no.
        self.prompter.yn.side_effect = [True, False, False]
    ...
    def test_refresh_code_reviews(self):
        ...
        self.prompter.yn.side_effect = [True, True, False]
